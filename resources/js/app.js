...
const store = createStore({
    state() {
        return {
            item: {},
            transacao: {status: '', mensage: '', dados: ''},
        };
    },
});
...
app.component("example-component", ExampleComponent)
    ...
    .component("marcas-component", MarcasComponent)
    .component("input-container-component", InputContainerComponent)
    .component("table-component", TableComponent)
    .component("card-component", CardComponent)
    .component("alert-component", AlertComponent)
    .component("paginate-component", PaginateComponent)
